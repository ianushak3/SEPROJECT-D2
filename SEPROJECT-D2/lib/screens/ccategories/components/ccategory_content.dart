...
class cPopularProducts extends StatefulWidget {
  State<cPopularProducts> createState() => _MycPopularProducts();
}

class _MycPopularProducts extends State<cPopularProducts> {
  ...
  void initState() {
    super.initState();
    futureProducts = getVegetables();
  }

  Future<List<Product>> getVegetables() async {
    final response =
        await get(Uri.parse('http://127.0.0.1:5182/api/vegetables'));
